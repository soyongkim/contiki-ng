...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/coap/coap-example-server/my-coap-server.c</source>
      <commands>make my-coap-server.cooja TARGET=cooja</commands>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/coap/coap-example-client/my-coap-client.c</source>
      <commands>make my-coap-client.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>54.41891826125554</x>
        <y>29.70889537061543</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>70.61182865599078</x>
        <y>71.84689705511212</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.726532185943529 0.0 0.0 3.726532185943529 -31.66925501354281 -3.188427534699873</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
